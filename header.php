    ...
    <div class="container">
      ...
      <div class="site-header__menu group">
        <nav class="main-navigation">
          ...
          <!-- Code pour rendre le menu dynamique 
          <?php
          // wp_nav_menu(array(
          ...
          <ul>
            <li <?php if(is_page('about-us') || wp_get_post_parent_id(0) == 5) echo 'class="current-menu-item"' ?>><a href="<?= site_url('/about-us') ?>">About Us</a></li>
