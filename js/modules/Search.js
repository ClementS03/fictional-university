            ...
            this.resultsDiv.html(`
                <div class="row">
                    <div class="one-third">
                        ...
                        ${results.generalInfo.length ? '<ul class="link-list min-list">' : '<p>No General infomations matches  that search</p>'}
                    ...
                    <div class="one-third">
                        ...
                        ${results.programs.length ? '<ul class="link-list min-list">' : `<p>No programs match thet search. <a href="${universityData.root_url}/programs">View all programs</a></p>`}
        ...
        <div class="search-overlay">
            ...
            <div class="container">
                <div id="search-overlay__results">
                    <!-- Search results goes here in JS -->
                </div>
            </div>
        </div>
        `);
